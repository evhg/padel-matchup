...
const STRINGS = {
  en: {
    ...
    coachLink: "Your lessons book: students book themselves, packages count themselves, and you get one link. Open it here; setup is four taps.",
    coachOpen: "Open my book",
  ...
  ru: {
    ...
    coachLink: "Ваша книга занятий: ученики записываются сами, абонементы считаются сами, а у вас одна ссылка. Откройте здесь; настройка — четыре нажатия.",
    coachOpen: "Открыть книгу",
