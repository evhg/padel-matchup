...
When a match has a seat nobody is waiting for, between 90 minutes and 48 hours before it starts, the people who would take it hear once: the group, whoever asked for that time, the players who played a finished match with somebody in it in the last 60 days, and the venue's regulars when the match is on its board. A private match reaches only those past partners. In Telegram that is a private message with a one-tap join.
