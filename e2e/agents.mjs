...
try {
  ...
  check("MCP lists the fifteen tools with schemas", tools.result.tools.length === 15 && tools.result.tools.every((t) => t.inputSchema && t.inputSchema.type === "object") && tools.result.tools.some((t) => t.name === "create_match") && tools.result.tools.some((t) => t.name === "find_series"));
