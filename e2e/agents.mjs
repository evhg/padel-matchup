...
try {
  ...
  check("MCP lists the fourteen tools with schemas", tools.result.tools.length === 14 && tools.result.tools.every((t) => t.inputSchema && t.inputSchema.type === "object") && tools.result.tools.some((t) => t.name === "create_match"));
