...
const STRINGS = {
  en: {
    ...
    feedbackAdded: "Added to your note. It goes back on my desk today.",
    toastSaved: "Saved ✅",
    share: "📤 Share",
  ...
  ru: {
    ...
    feedbackAdded: "Добавил к вашей заметке. Сегодня она снова у меня на столе.",
