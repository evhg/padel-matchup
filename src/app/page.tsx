...
export default async function Home({ searchParams }: { searchParams: Promise<{ type?: string; capacity?: string; group?: string; venue?: string; tg?: string }> }) {
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-full max-w-xl flex-col gap-4 px-4 pt-2">
        <CreateScreen heading={t("landing.formTitle")} sub={t("landing.formSub")} prefill={{ type: sp.type, capacity: sp.capacity, group: sp.group, venue: sp.venue, tg: sp.tg }} />
