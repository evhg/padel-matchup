...
describe("MCP handler", () => {
  it("initialize, tools/list, tools/call, resources, notifications and errors", async () => {
    ...
    expect(tools.map((t) => t.name)).toEqual(["about_kicksmash", "get_match", "find_matches", "get_group", "generate_schedule", "find_clubs", "find_series", "find_coaches", "coach_slots", "request_coach", "book_lesson", "cancel_lesson", "create_match", "join_match", "create_api_key"]);
