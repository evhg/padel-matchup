...
19. **Coaches arrive on their own.** Every place a coach can be seen is a door to their own book: the front page at `/coaches`, the coach page, the club page, the city list, the invite a coach forwards. Nobody onboards a coach by hand; the two introductions the owner makes are the exception that proves it. Each sign-up carries the door it came through, and the Sunday digest counts them, so a door that brings nobody gets redesigned, not marketed.
