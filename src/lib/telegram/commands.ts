...
export const BOT_COMMANDS = {
  en: [
    ...
    { command: "want", description: "When you want to play: /want tue 14 Rawai Padel" },
  ...
  ru: [
    ...
    { command: "want", description: "Когда хотите играть: /want вт 14 Rawai Padel" },
  ...
  es: [
    ...
    { command: "want", description: "Cuándo quieres jugar: /want mar 14 Rawai Padel" },
