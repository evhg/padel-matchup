...
const STRINGS = {
  en: {
    ...
    added: "Added to your note. It goes back on my desk today.",
  ...
  ru: {
    ...
    added: "Добавил к вашей заметке. Сегодня она снова у меня на столе.",
  ...
  es: {
    ...
    added: "Añadido a tu nota. Hoy vuelve a mi mesa.",
